...
// Output manifest types (shared contract between L1 and L2)
export type { OutputManifest, OutputEntry } from "./output-manifest.types.js";

// Re-export GroupChat types from collaboration layer
export type {
  GroupChatOutcome,
  ActionItem,
  GroupMessage,
  SharedBinary,
} from "../L2/collaboration/types/group-chat.types.js";

// Import OutputManifest for use in interfaces below
import type { OutputManifest } from "../L2/collaboration/types/output-manifest.types.js";
