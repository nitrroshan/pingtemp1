...
const sheetVariants = {
  right: 'inset-y-0 right-0 h-full w-80 border-l data-[state=open]:animate-slide-in-right',
  left: 'inset-y-0 left-0 h-full w-80 border-r data-[state=open]:animate-slide-in-left',
...
const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 p-4 border-t border-border mt-auto', className)} {...props} />
);
